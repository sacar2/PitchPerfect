...
extension PlaySoundsViewController: AVAudioPlayerDelegate {
    ...
    func setPlayButtonsEnabled(enabled: Bool) {
        snail_button.enabled = enabled
        chipmunk_button.enabled = enabled
        rabbit_button.enabled = enabled
        darthvader_button.enabled = enabled
        parrot_button.enabled = enabled
        reverb_button.enabled = enabled
